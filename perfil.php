                  ...
                  <table class="table table-condensed">
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" class="form-control input-sm" name="nombre_empresa" value="Nombre de la empresa" required></td>
                      </tr>
                      <tr>
                        <td>Teléfono:</td>
                        <td><input type="text" class="form-control input-sm" name="telefono" value="91-85596612" required></td>
                      </tr>
                      <tr>
                        <td>Correo electrónico:</td>
                        <td><input type="email" class="form-control input-sm" name="email" value="hola@hola.com" ></td>
                      </tr>
					  <tr>
                        <td>IVA (%):</td>
					  ...
					  <tr>
                        <td>Dirección:</td>
                        <td><input type="text" class="form-control input-sm" name="direccion" value="calle Principal, 123" required></td>
                      </tr>
					  <tr>
                        <td>Ciudad:</td>
                        <td><input type="text" class="form-control input-sm" name="ciudad" value="Málaga" required></td>
                      </tr>
					  <tr>
                        <td>Región/Provincia:</td>
                        <td><input type="text" class="form-control input-sm" name="estado" value="Málaga"></td>
                      </tr>
					  <tr>
                        <td>Código postal:</td>
                        <td><input type="text" class="form-control input-sm" name="codigo_postal" value="29001"></td>
                      </tr>
